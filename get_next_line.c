...
/*   Updated: 2024/06/04 11:13:56 by luiz-dos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
* read the file, create a line, put the rest in the static variable for the next call
...
char    *get_next_line(int fd)
{
    ...
    if (BUFFER_SIZE > 2147483647 || read(fd, 0, 0) < 0 || fd >= FOPEN_MAX || fd < 0 || BUFFER_SIZE <= 0)
        return (NULL);
    line = NULL;
    found_newline = 0;
